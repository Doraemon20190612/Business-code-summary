...
# 导入待匹配数据    
data_qz = pd.read_excel(r'C:\Users\sb\Desktop\奇正医院匹配实验数据.xlsx',sheetname = 4)
data_cy = pd.read_excel(r'C:\Users\sb\Desktop\奇正医院匹配实验数据.xlsx',sheetname = 5)
...
new.to_excel(r'C:\Users\sb\Desktop\医院匹配实验数据结果.xlsx')